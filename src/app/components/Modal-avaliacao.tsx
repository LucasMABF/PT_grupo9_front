...
const ModalAvaliacao: React.FC<ModalAvaliacaoProps> = ({ onClose }) => {
    ...
    return (
        ...
        <div className="body z-10 fixed bg-gray-800 bg-opacity-75 w-full h-full flex justify-center items-center">
            <form action="POST" className="evaluation-container bg-green-700 flex flex-col items-center justify-center px-10 py-12 w-3/5 rounded-xl">
                <input type="text" placeholder="Nome do professor" list="professores" className="my-2 bg-blue-100 tracking-wider text-x1 w-full px-4 text-black p-2.5 rounded-full" />
                    ...
                    <div className="container-footer flex justify-end items-end">
                        <div className="-mr-96 flex">
                            <div onClick = {onClose} className="cancel py-2 px-6 tracking-wider border-2 border-green-700 rounded-lg hover:border-green-600" >Cancelar</div>
                            <button type="submit" className="submit cursor-pointer mx-4 rounded-lg bg-green-600 py-2 px-6 tracking-wider border-2 border-green-600 hover:bg-transparent">Avaliar</button>
                        </div>        
                    </div>
            </form>
        </div>
